      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className={`fixed z-[201] bg-[#3E3636] rounded-2xl overflow-hidden flex flex-col ${
          ...
          >
            ...
            <div className="flex items-center justify-between p-4 border-b border-white/10">
              <h2 className="text-lg font-semibold text-[#F5EDED]">{title}</h2>
              <div className="flex items-center gap-2">
                ...
                >
                  <ZoomOut size={18} className="text-[#F5EDED]" />
                </button>
                <span className="text-sm text-[#F5EDED] w-12 text-center">{scale}%</span>
                <button
                  onClick={handleZoomIn}
                  title="Zoom In"
                  className="p-2 hover:bg-white/10 rounded-lg transition-colors"
                >
                  <ZoomIn size={18} className="text-[#F5EDED]" />
                </button>
                <button
                  ...
                  className="p-2 hover:bg-white/10 rounded-lg transition-colors"
                >
                  <Maximize2 size={18} className="text-[#F5EDED]" />
                </button>
                <button
                  onClick={handleDownload}
                  title="Download"
                  className="p-2 hover:bg-[#D72323] rounded-lg transition-colors"
                >
                  <Download size={18} className="text-[#F5EDED]" />
                </button>
                <button
                  onClick={onClose}
                  className="p-2 hover:bg-[#D72323] rounded-lg transition-colors"
                >
                  <X size={18} className="text-[#F5EDED]" />
                </button>
              </div>
            </div>
