...
export function EnhancedCertCard({ cert, onViewPDF }: EnhancedCertCardProps) {
  ...
  return (
    ...
    >
      ...
      <h3 className="font-bold font-sora text-base leading-tight mb-1.5" style={{ color: "#F5EDED" }}>
        {cert.title}
      </h3>
      ...
      <div className="flex items-center justify-between text-xs mb-4">
        <span style={{ color: "rgba(245,237,237,0.4)" }}>Issued: {cert.issueDate}</span>
        {cert.credentialId && (
      ...
      {/* Description */}
      {cert.description && (
        <p className="text-sm mb-4 leading-relaxed" style={{ color: "rgba(245,237,237,0.45)" }}>
          {cert.description}
        </p>
      )}
        ...
        {hov && (
          ...
          >
            <div className="flex items-center gap-2 text-xs">
              ...
              <span style={{ color: "rgba(245,237,237,0.6)" }}>Click to view certificate PDF</span>
            </div>
            <motion.div
      ...
      <section id="certifications" className="py-32 relative z-10">
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            <span className="text-xs font-jetbrains tracking-[0.3em] uppercase mb-4 block" style={{ color: "#D72323" }}>Credentials</span>
            <h2 className="text-4xl md:text-5xl font-bold font-sora mb-5" style={{ color: "#F5EDED" }}>Certifications</h2>
            <p className="text-lg max-w-2xl mx-auto leading-relaxed" style={{ color: "rgba(245,237,237,0.45)" }}>Industry-recognised certifications that validate my technical skills.</p>
          </div>
          ...
          {!isLoading && (
            <>
              ...
              <p className="text-center text-xs font-jetbrains mt-6" style={{ color: "rgba(245,237,237,0.2)" }}>
